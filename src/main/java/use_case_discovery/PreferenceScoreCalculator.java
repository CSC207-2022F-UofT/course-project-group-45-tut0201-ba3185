 ...
 * The score is calculated based on the position of matches, it follows the algorithm below:
 ...
 */
public class PreferenceScoreCalculator extends csvInteractor implements ScoreCalculator{
    ...
    public int getScore(){
        int resScore = 0;//to record the score of the given other user
        int sameCount = 0; //to record the number of matches
